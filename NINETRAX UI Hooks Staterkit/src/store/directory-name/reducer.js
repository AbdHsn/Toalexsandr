...
const directoryNameReducer = (state = INIT_STATE, action) => {
  ...
  switch (action.type) {
    case actionType.GET_DIRECTORYNAMES_VIEW:
      return {
        ...state,
        isFetching: true,
      }
    case actionType.GET_DIRECTORYNAMES_VIEW_SUCCESS:
      return {
        ...state,
    ...
    case actionType.GET_DIRECTORYNAMES_VIEW_FAIL:
      return {
        ...state,
        error: action.payload,
        isFetching: false,
        message: "Failed to fetch directory names",
      }
